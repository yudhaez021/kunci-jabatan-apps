...
<html lang="en">
  <head>
    ...
    <title>Kunci Jabatan Apps | Dashboard</title>
          ...
          <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="dashboard_graph">
                <h2>Aktifitas Terakhir Administrator</h2>
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $__data = mysqli_query($koneksi,"SELECT * FROM log_administrator ORDER by tanggal DESC LIMIT 5 "); ?>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="dashboard_graph">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $__data = mysqli_query($koneksi,"SELECT * FROM log_user ORDER by tanggal DESC LIMIT 5 "); ?>
                        <?php while($d = mysqli_fetch_array($__data)){ ?>
                        <tr>
                            <th scope="row"><?php echo $d['id']; ?></th>
