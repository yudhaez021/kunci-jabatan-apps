...
$_SESSION['__data'] = 'login'; // daftar_kartu = nama table
...
<html lang="en">
  <head>
    ...
    <title>Kunci Jabatan Apps | Manajemen Administrator</title>
              ...
              <div class="dashboard_graph">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <th><a href="#" class="btn btn-sm btn-info" data-toggle="modal" data-target="#edit_<?php echo $d['id']; ?>"><i class="fa fa-pencil"></i></a> <?php if ($data['username'] != $d['username']) { ?><a href="#" data-toggle="modal" data-target="#delete_<?php echo $d['id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-remove"></i></a> <?php } ?></th>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="helper_post.php?key=<?php echo $_SESSION['__data']; ?>&href=manajemen_administrator">
...
<div class="modal fade" id="edit_<?php echo $d['id']; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="helper_post.php?key=<?php echo $_SESSION['__data']; ?>&href=manajemen_administrator&where=<?php echo $d['username']; ?>">

                <input type="hidden" name="data[id]" id="id" class="form-control" value="<?php echo $d['id']; ?>" />
                <div class="form-group">
                    <label for="username">Username</label>
                    <input type="text" name="data[username]" id="username" class="form-control" value="<?php echo $d['username']; ?>" />
                </div>
				
                <div class="form-group">
                    <label for="password">Password</label>
                    <input type="password" name="data[password]" id="password" class="form-control" value="<?php echo $d['password']; ?>" />
                </div>
            </div>    
...
<div class="modal fade" id="delete_<?php echo $d['id']; ?>" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-danger btn-sm" href="helper_delete.php?id=<?php echo $d['id']; ?>&key=<?php echo $_SESSION['__data']; ?>&href=manajemen_administrator&where=<?php echo $d['username']; ?>">Delete</a>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
